...
<tr>
  ...
  <td>
  Your collection has been <b>successfully</b> submitted; you may get reference to it with identifier:<br>
...
<td>Press the <b>Run a new application</b> button to start another job collection submission</td>
</tr>
</table>
