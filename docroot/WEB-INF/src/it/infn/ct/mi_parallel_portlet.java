...
//                    long sizeInBytes = item.getSize();
        ...
        _log.info(
                ...
                + LS + "collectionType: '" + appInput.collectionType + "'"
                + LS + "taskNumber: '" + appInput.taskNumber + "'"
                + LS + tmp
                + LS + "finalJobExecutable: '" + appInput.finalJobExecutable + "'"
                + LS + "finalJobArgument: '" + appInput.finalJobArgument + "'"
                + LS);
    ...
    void submitJob(AppInput appInput) {
        ...
        for (int i = 0; i < Integer.parseInt(appInput.taskNumber); i++) {
            ...
            switch (CollectionType.valueOf(appInput.collectionType)) {
                ...
                case WORKFLOW_N1:
                    ...
                    description.setExecutable(appInput.executables.get(i));
                ...
                case JOB_PARAMETRIC:
                    ...
                    description.setExecutable(appInput.executable);
                    description.setInputFiles(appServerPath + "WEB-INF/job/pilot_script.sh");
                    break;
            }


            description.setArguments(appInput.arguments.get(i));
        ...
        switch (CollectionType.valueOf(appInput.collectionType)) {
            ...
            case WORKFLOW_N1:
                ...
                finalJobDescription.setArguments(appInput.finalJobArgument);
                ...
                collection = new WorkflowN1(appInput.username, appInput.jobIdentifier, "/tmp", descriptions, finalJobDescription);
                break;
            case JOB_PARAMETRIC:
                collection = new JobParametric(appInput.username, appInput.jobIdentifier, "/tmp", descriptions, appInput.executable);
                break;
        }
        ...
        if (infrastructuresInfo.length > 0) {
            ...
            // Submit Collection
            tmpJobCollectionSubmission.submitJobCollection(infrastructuresInfo,
